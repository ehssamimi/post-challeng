...
const Input = ({label,name,status,ChangeInput}) => {
    ...
    let InputClass={
        classInputNormal:`  bg-[url('/Img/Input/lock-normal.svg')]  border-blackLight`,
        classInputFocus:`focus:outline-none focus:border-black caret-black focus:bg-[url('/Img/Input/lock-black.svg')] bg-[url('/Img/Input/lock-black.svg')]`,
        classInputError:`focus:outline-Persimmon border-Persimmon  caret-Persimmon  bg-[url('/Img/Input/lock-error.svg')] focus:bg-[url('/Img/Input/lock-error.svg')]`,
        classInputSuccess:`focus:outline-Malachite  border-Malachite  caret-Malachite bg-[url('/Img/Input/lock-success.svg')]   focus:bg-[url('/Img/Input/lock-success.svg')]`,
